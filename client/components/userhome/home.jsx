Home = React.createClass({
  ...
  askFriend() {
    if (this.data.homeUser._id !== Meteor.userId() && this.dta.homeUser.profile.friends.indexOf(Meteor.userId()) === -1) {
                    ...
                    <div className="col-md-12">
                      <div className="form-group">
                        ...
                        <div className="input-group">
                          ...
                          <input readOnly type="to" className="form-control" id="to" name="to" placeholder="Send Message To" value={this.data.homeUser && this.data.homeUser.profile.firstname + " " + this.data.homeUser.profile.lastname}/>
                        </div>
                        <div className="form-group">
                          <label htmlFor="subject">Subject</label>
                          <input type="text" ref="subject" name="subject" className="form-control" id="subject" placeholder="Subject" required="required"/>
                        </div>
                        <div className="form-group">
                          <label htmlFor="name">Message</label>
                          <textarea ref="message" name="message" id="message" cols="25" rows="9" className="form-control" required="required" placeholder="Message"></textarea>
                        </div>
                      </div>
                    </div>
                    <div className="col-md-12">
                      <div className="control-group">
                        <label htmlFor="button1id" className="control-label"></label>
